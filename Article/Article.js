...
function article(props) {
    ...
    p1.textContent = props.firstParagraph;
    p2.textContent = props.secondParagraph;
    p3.textContent = props.thirdParagraph;
...
/* Step 1: Create a function that creates a component. You will want your component to look like the template below:
  ...
  XYour function should take either an object as it's one argument, or 5 separate arguments mapping to each piece of the data object above.

  XStep 2: Add an event listener to the expandButton span. This event listener should toggle the class 'article-open' on the 'article' div.
